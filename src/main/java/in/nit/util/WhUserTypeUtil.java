...
JFreeChart chart=ChartFactory.createPieChart3D("WhUser Types", dataset, true, true, false);
...
try {
	...
	public void generateBar(String path, List<Object[]> data)
	{
		...
		JFreeChart chart=ChartFactory.createBarChart("WhUser Types", "Types", "COUNT",dataset);

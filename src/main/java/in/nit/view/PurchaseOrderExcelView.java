...
public class PurchaseOrderExcelView extends AbstractXlsxView {
	...
	protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
		 ...
		 */
			...
			r.createCell(3).setCellValue("QUALITY");
			r.createCell(4).setCellValue("STATUS");
		...
		private void setBody(Sheet s,List<PurchaseOrder> list)
		{
			 ...
			 * r.createCell(3).setCellValue(po.getUserType());
			 */
				r.createCell(2).setCellValue(po.getRefNumber());
				r.createCell(3).setCellValue(po.getQualityCheck());
				r.createCell(4).setCellValue(po.getDefaultStatus());
				r.createCell(5).setCellValue(po.getPurDesc());

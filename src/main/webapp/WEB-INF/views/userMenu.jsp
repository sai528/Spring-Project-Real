		...
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item dropdown"><a
				...
				<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					...
					<div class="dropdown-divider"></div>
					<a class="dropdown-item" href="${url}/order/allorders">ALL</a>
					<div class="dropdown-divider"></div>
			...
			<li class="nav-item dropdown"><a
				...
				<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					...
					<div class="dropdown-divider"></div>
					<a class="dropdown-item" href="${url}/uom/alluoms">ALL</a>
					<div class="dropdown-divider"></div>
			...
			<li class="nav-item dropdown"><a
				...
				<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					...
					<div class="dropdown-divider"></div>
					<a class="dropdown-item" href="${url}/whuser/allwhusers">ALL</a>
					<div class="dropdown-divider"></div>
          ...
          <a class="dropdown-item" href="${url}/whuser/charts">CHARTS</a>
			...
			<li class="nav-item dropdown"><a
				class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
				role="button" data-toggle="dropdown" aria-haspopup="true"
				aria-expanded="false"> PURCHASE/SALE </a>

				<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					<a class="dropdown-item" href="${url}/purchase/register">PURCHASE
						REGISTER</a>
					<div class="dropdown-divider"></div>
